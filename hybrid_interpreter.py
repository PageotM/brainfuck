...
def runScript( script=script,writerPos=writerPos, valueList=valueList, lecteurPos=lecteurPos, renderSteps = False, stepByStep=True, renderFinalResult=True, countIter = True):
    n = 0
    while True:
...
runScript("++[->-<]",renderSteps=True, stepByStep=True, countIter=True)